  ...
  return (
    <div className="sm:container mx-auto text-lg mt-10">
      ...
      <p className="text-lg mb-4">
        ...
        Web Coding Agency and how we use it.
      </p>
      ...
      <p className="text-lg mb-4">
        ...
        shared and/or collect in Web Coding Agency. This policy is not
        applicable to any information collected offline or via channels other
        than this website. Our Privacy Policy was created with the help of the{' '}
      </p>

      <h2 className="text-2xl  mb-4 font-sans font-semibold">Consent</h2>
      ...
      <ul className="text-lg mb-4 list-disc ml-5">
      ...
      <h2 className="text-2xl  mb-4 font-sans font-semibold">Log Files</h2>

      <p className="text-lg mb-4">
        Web Coding Agency follows a standard procedure of using log files. These
      ...
      <p className="text-lg mb-4">
        Like any other website, Web Coding Agency uses 'cookies'. These cookies
      ...
      <p className="text-lg mb-4">
        ...
        advertising partners of Web Coding Agency.
      </p>

      <p className="text-lg mb-4">
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Web Coding Agency, which are
      ...
      <p className="text-lg mb-4">
        Note that Web Coding Agency has no access to or control over these
        cookies that are used by third-party advertisers.
      </p>

      <h2 className="text-lg mb-4">Third Party Privacy Policies</h2>

      <p className="text-lg mb-4">
        Web Coding Agency's Privacy Policy does not apply to other advertisers
      ...
      <p className="text-lg mb-4">
        Web Coding Agency does not knowingly collect any Personal Identifiable
